...
json_file = f'/home/yanggk/CO_Bert/config/config_conv_{mode}.json'
...
train_idx = np.load('/home/yanggk/CO_Bert/data/train.npy')
val_idx = np.load('/home/yanggk/CO_Bert/data/valid.npy')
test_idx = np.load('/home/yanggk/CO_Bert/data/test.npy')
...
# test_loss,draw_datas,Label_data = trainer.test(test_loader)
# print(f'Test Loss: {test_loss:.4f}')
#         # print(draw_datas)
# trainer.draw_pict(draw_datas)
# trainer.draw_hm(Label_data)
